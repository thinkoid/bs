...
static void
process_simple_frame_difference (cv::VideoCapture& cap, const options_t& opts) {
...
int main (int argc, char** argv) {
    ...
    return run_with (process_simple_frame_difference, global_options ()), 0;
}
